...
class InvitationWorkspaceRepository {
    ...
    async getInvitationByInviterInvitedAndWorkspace(inviter_user_id, invited_user_id, workspace_id) {
        return await InvitationWorkspace.findOne({
            fk_inviter_user_id: inviter_user_id,
            fk_invited_user_id: invited_user_id,
